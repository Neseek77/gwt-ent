...
*/
package com.gwtent.client.test.validate.tck.util;
...
//	}
	...
	private static <U extends ValidationProvider<?>> void instantiateValidationProviderUnderTest() {
		...
		try {
			...
			Class<U> tmpClazz = (Class<U>) ClassHelper.forName(validatorProviderClassName);
		...
		try {
			validationProviderUnderTest = ClassHelper.AsClass(providerClass).newInstance();
		}
		catch ( Exception e ) {
