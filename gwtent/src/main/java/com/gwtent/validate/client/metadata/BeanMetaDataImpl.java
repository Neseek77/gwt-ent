// $Id: BeanMetaDataImpl.java 17638 2009-10-07 08:31:13Z hardy.ferentschik $
/*
...
import com.gwtent.reflection.client.AnnotatedElement;
import com.gwtent.reflection.client.ClassHelper;
import com.gwtent.reflection.client.Field;
import com.gwtent.reflection.client.Member;
import com.gwtent.reflection.client.Method;
import com.gwtent.validate.client.util.GetDeclaredFields;
...
//		}
	...
	private void initDefaultGroupSequence() {
		...
		GroupSequence groupSequenceAnnotation = ClassHelper.AsClass(beanClass).getAnnotation( GroupSequence.class );
	...
	private void initFieldConstraints(Class<?> clazz, AnnotationIgnores annotationIgnores) {
		...
		for ( Field field : fields ) {
			// HV-172
			if ( field.isStatic()/* Modifier.isStatic( field.getModifiers() ) */) {
				continue;
			}
...
//		}
	...
	private void initMethodConstraints(Class<?> clazz, AnnotationIgnores annotationIgnores) {
		...
		for ( Method method : declaredMethods ) {
			// HV-172
			if ( method.isStatic() /* Modifier.isStatic( method.getModifiers() ) */) {
				continue;
			}
	...
	private PropertyDescriptorImpl addPropertyDescriptorForMember(Object member, boolean isCascaded) {
	...
	private List<ConstraintDescriptorImpl<?>> findClassLevelConstraints(Class<?> beanClass) {
		...
		for ( Annotation annotation : ClassHelper.AsClass(beanClass).getAnnotations() ) {
