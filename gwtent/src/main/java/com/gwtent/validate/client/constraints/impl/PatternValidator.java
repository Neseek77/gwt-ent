 ...
 */
public class PatternValidator extends RegularBasedValidator<Pattern, String> implements ConstraintValidator<Pattern, String> {

	private String regex;

	public void initialize(Pattern r) {
		regex = r.regexp();
	}
